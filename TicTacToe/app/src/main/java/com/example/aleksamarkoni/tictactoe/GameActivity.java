package com.example.aleksamarkoni.tictactoe;
...
import com.example.aleksamarkoni.tictactoe.GameView.ICellListener;
import com.example.aleksamarkoni.tictactoe.GameView.State;
...
public class GameActivity extends Activity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        mInfoView = findViewById(R.id.info_turn);
        mButtonNext = findViewById(R.id.next_turn);
